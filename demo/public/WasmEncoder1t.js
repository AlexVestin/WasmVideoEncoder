...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'WasmEncoder1t.wast';
  var wasmBinaryFile = 'WasmEncoder1t.wasm';
  var asmjsCodeFile = 'WasmEncoder1t.temp.asm.js';
...
STATICTOP = STATIC_BASE + 1992656;
/* global initializers */ if (!ENVIRONMENT_IS_PTHREAD) __ATINIT__.push({ func: function() { ___emscripten_pthread_data_constructor() } }, { func: function() { ___emscripten_environ_constructor() } });


if (!ENVIRONMENT_IS_PTHREAD) {
memoryInitializer = "WasmEncoder1t.js.mem";
}




var STATIC_BUMP = 1992656;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr; if (ENVIRONMENT_IS_PTHREAD) _stderr = PthreadWorkerInit._stderr; else PthreadWorkerInit._stderr = _stderr = allocate(1, "i32*", ALLOC_STATIC);var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
      ...
      }};function ___syscall140(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 140, varargs) }
  ...
  function ___syscall145(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 145, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // readv
  ...
  function ___syscall146(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 146, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // writev
      var stream = SYSCALLS.getStreamFromFD(), iov = SYSCALLS.get(), iovcnt = SYSCALLS.get();
  ...
  function ___syscall195(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 195, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // SYS_stat64
  ...
  function ___syscall197(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 197, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // SYS_fstat64
  ...
  function ___syscall219(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 219, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // madvise
  ...
  function ___syscall221(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 221, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // fcntl64
  ...
  function ___syscall3(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 3, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // read
  ...
  function ___syscall34(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 34, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // nice
  ...
  function ___syscall38(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 38, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // rename
  ...
  function ___syscall5(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 5, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // open
  ...
  function ___syscall54(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 54, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // ioctl
  ...
  function ___syscall6(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 6, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // close
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_iiii(1, target, width, height); return _emscripten_get_canvas_element_size_calling_thread(target, width, height); }function _emscripten_get_canvas_element_size(target, width, height) {
      var canvas = JSEvents.findCanvasEventTarget(target);
  ...
  function __set_canvas_element_size(target, width, height) {
      if (!target.controlTransferredOffscreen) {
        ...
        var deviceOrientationEventHandlerFunc = function(event) {
          ...
          if (targetThread) {
            var deviceOrientationEvent = _malloc( 40 );
        ...
        var orientationChangeEventHandlerFunc = function(event) {
          ...
          var orientationChangeEvent = targetThread ? _malloc( 80 ) : JSEvents.orientationChangeEvent;
      ...
      _emscripten_async_queue_on_thread_(targetThread, 657457152, 0, targetStrHeap /* satellite data */, varargs);
      stackRestore(stackTop);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_iiii(2, target, width, height); return _emscripten_set_canvas_element_size_calling_thread(target, width, height); }function _emscripten_set_canvas_element_size(target, width, height) {
      var canvas = JSEvents.findCanvasEventTarget(target);
  ...
  function _tzset() {
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_v(4);
  ...
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_sync_run_in_browser_thread_ii(5, name);
...
var proxiedFunctionTable = [null,_emscripten_get_canvas_element_size_main_thread,_emscripten_set_canvas_element_size_main_thread,_getenv,_tzset,_sysconf];
...
function nullFunc_fiiiiiiiiffii(x) { err("Invalid function pointer called with signature 'fiiiiiiiiffii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_iiifii(x) { err("Invalid function pointer called with signature 'iiifii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_iiiiiiidiiddii(x) { err("Invalid function pointer called with signature 'iiiiiiidiiddii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_jiiji(x) { err("Invalid function pointer called with signature 'jiiji'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_viiiiiiff(x) { err("Invalid function pointer called with signature 'viiiiiiff'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }

function nullFunc_viiiiiii(x) { err("Invalid function pointer called with signature 'viiiiiii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }

function nullFunc_viiiiiiifi(x) { err("Invalid function pointer called with signature 'viiiiiiifi'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
Module['wasmTableSize'] = 26064;

Module['wasmMaxTableSize'] = 26064;

Module.asmGlobalArg = {};

Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "setTempRet0": setTempRet0, "getTempRet0": getTempRet0, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_dd": nullFunc_dd, "nullFunc_did": nullFunc_did, "nullFunc_didd": nullFunc_didd, "nullFunc_fiii": nullFunc_fiii, "nullFunc_fiiiiiiiiffii": nullFunc_fiiiiiiiiffii, "nullFunc_i": nullFunc_i, "nullFunc_ii": nullFunc_ii, "nullFunc_iii": nullFunc_iii, "nullFunc_iiifii": nullFunc_iiifii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_iiiii": nullFunc_iiiii, "nullFunc_iiiiii": nullFunc_iiiiii, "nullFunc_iiiiiii": nullFunc_iiiiiii, "nullFunc_iiiiiiidiiddii": nullFunc_iiiiiiidiiddii, "nullFunc_iiiiiiii": nullFunc_iiiiiiii, "nullFunc_iiiiiiiii": nullFunc_iiiiiiiii, "nullFunc_iiiiiiiiii": nullFunc_iiiiiiiiii, "nullFunc_iiiiij": nullFunc_iiiiij, "nullFunc_iij": nullFunc_iij, "nullFunc_jii": nullFunc_jii, "nullFunc_jiiii": nullFunc_jiiii, "nullFunc_jiiji": nullFunc_jiiji, "nullFunc_jij": nullFunc_jij, "nullFunc_jiji": nullFunc_jiji, "nullFunc_v": nullFunc_v, "nullFunc_vf": nullFunc_vf, "nullFunc_vff": nullFunc_vff, "nullFunc_vfff": nullFunc_vfff, "nullFunc_vffff": nullFunc_vffff, "nullFunc_vi": nullFunc_vi, "nullFunc_vif": nullFunc_vif, "nullFunc_viff": nullFunc_viff, "nullFunc_vifff": nullFunc_vifff, "nullFunc_viffff": nullFunc_viffff, "nullFunc_vii": nullFunc_vii, "nullFunc_viidi": nullFunc_viidi, "nullFunc_viif": nullFunc_viif, "nullFunc_viifi": nullFunc_viifi, "nullFunc_viii": nullFunc_viii, "nullFunc_viiif": nullFunc_viiif, "nullFunc_viiii": nullFunc_viiii, "nullFunc_viiiif": nullFunc_viiiif, "nullFunc_viiiii": nullFunc_viiiii, "nullFunc_viiiiii": nullFunc_viiiiii, "nullFunc_viiiiiiff": nullFunc_viiiiiiff, "nullFunc_viiiiiii": nullFunc_viiiiiii, "nullFunc_viiiiiiifi": nullFunc_viiiiiiifi, "nullFunc_viiiiiiii": nullFunc_viiiiiiii, "nullFunc_viiiiiiiii": nullFunc_viiiiiiiii, "nullFunc_viiiiiiiiii": nullFunc_viiiiiiiiii, "nullFunc_viiiiiiiiiii": nullFunc_viiiiiiiiiii, "nullFunc_viiijj": nullFunc_viiijj, "___assert_fail": ___assert_fail, "___buildEnvironment": ___buildEnvironment, "___call_main": ___call_main, "___clock_gettime": ___clock_gettime, "___lock": ___lock, "___setErrNo": ___setErrNo, "___syscall140": ___syscall140, "___syscall145": ___syscall145, "___syscall146": ___syscall146, "___syscall195": ___syscall195, "___syscall197": ___syscall197, "___syscall219": ___syscall219, "___syscall221": ___syscall221, "___syscall3": ___syscall3, "___syscall34": ___syscall34, "___syscall38": ___syscall38, "___syscall5": ___syscall5, "___syscall54": ___syscall54, "___syscall6": ___syscall6, "___unlock": ___unlock, "__addDays": __addDays, "__arraySum": __arraySum, "__cleanup_thread": __cleanup_thread, "__exit": __exit, "__get_canvas_element_size": __get_canvas_element_size, "__isLeapYear": __isLeapYear, "__pthread_testcancel_js": __pthread_testcancel_js, "__set_canvas_element_size": __set_canvas_element_size, "__spawn_thread": __spawn_thread, "_abort": _abort, "_clock": _clock, "_clock_gettime": _clock_gettime, "_emscripten_asm_const_i": _emscripten_asm_const_i, "_emscripten_asm_const_ii": _emscripten_asm_const_ii, "_emscripten_conditional_set_current_thread_status_js": _emscripten_conditional_set_current_thread_status_js, "_emscripten_futex_wait": _emscripten_futex_wait, "_emscripten_futex_wake": _emscripten_futex_wake, "_emscripten_get_canvas_element_size": _emscripten_get_canvas_element_size, "_emscripten_get_canvas_element_size_calling_thread": _emscripten_get_canvas_element_size_calling_thread, "_emscripten_get_canvas_element_size_main_thread": _emscripten_get_canvas_element_size_main_thread, "_emscripten_get_now": _emscripten_get_now, "_emscripten_get_now_is_monotonic": _emscripten_get_now_is_monotonic, "_emscripten_has_threading_support": _emscripten_has_threading_support, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_set_canvas_element_size": _emscripten_set_canvas_element_size, "_emscripten_set_canvas_element_size_calling_thread": _emscripten_set_canvas_element_size_calling_thread, "_emscripten_set_canvas_element_size_main_thread": _emscripten_set_canvas_element_size_main_thread, "_emscripten_set_current_thread_status_js": _emscripten_set_current_thread_status_js, "_emscripten_set_offscreencanvas_size_on_target_thread": _emscripten_set_offscreencanvas_size_on_target_thread, "_emscripten_set_thread_name_js": _emscripten_set_thread_name_js, "_emscripten_syscall": _emscripten_syscall, "_emscripten_webgl_create_context": _emscripten_webgl_create_context, "_exit": _exit, "_fabs": _fabs, "_getenv": _getenv, "_gettimeofday": _gettimeofday, "_gmtime_r": _gmtime_r, "_llvm_exp2_f32": _llvm_exp2_f32, "_llvm_exp2_f64": _llvm_exp2_f64, "_llvm_log10_f32": _llvm_log10_f32, "_llvm_log10_f64": _llvm_log10_f64, "_llvm_log2_f32": _llvm_log2_f32, "_llvm_log2_f64": _llvm_log2_f64, "_llvm_trunc_f64": _llvm_trunc_f64, "_localtime_r": _localtime_r, "_mktime": _mktime, "_pthread_cleanup_pop": _pthread_cleanup_pop, "_pthread_cleanup_push": _pthread_cleanup_push, "_pthread_create": _pthread_create, "_pthread_getschedparam": _pthread_getschedparam, "_pthread_join": _pthread_join, "_strftime": _strftime, "_sysconf": _sysconf, "_tzset": _tzset, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
